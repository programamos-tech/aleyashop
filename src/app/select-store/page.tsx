...
import Image from 'next/image' // Used for store logos
...
export default function SelectStorePage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#fce4f0] via-white to-[#fef0f5] dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        <div className="text-center">
          <Loader2 className="h-12 w-12 animate-spin text-[#f29fc8] mx-auto mb-4" />
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#fce4f0] via-white to-[#fef0f5] dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center p-4">
        ...
        <div className="sm:hidden grid grid-cols-3 gap-2 md:gap-4">
          ...
          {mainStore && (
            <Card
              ...
              className="cursor-pointer hover:shadow-lg transition-all duration-200 hover:scale-105 border-2 border-[#f29fc8]/40 dark:border-[#f29fc8]/50 bg-white dark:bg-gray-800"
            >
              <CardContent className="p-2 md:p-4 flex flex-col items-center text-center">
                <div className="relative w-12 h-12 md:w-16 md:h-16 rounded-full overflow-hidden bg-gray-100 dark:bg-gray-700 flex items-center justify-center shadow-md ring-2 ring-[#f29fc8]/40 dark:ring-[#f29fc8]/50 mb-1.5 md:mb-2">
                  {mainStore.logo ? (
                    <Image
                      src={mainStore.logo}
                      alt={mainStore.name}
          ...
          {mainStore && (
            ...
            >
              <CardContent className="p-4 md:p-6 flex flex-col items-center text-center">
                <div className="relative w-16 h-16 md:w-20 md:h-20 rounded-full overflow-hidden bg-gray-100 dark:bg-gray-700 flex items-center justify-center shadow-md ring-2 ring-[#f29fc8]/40 dark:ring-[#f29fc8]/50 mb-2 md:mb-3">
                  {mainStore.logo ? (
                    <Image
                      src={mainStore.logo}
                      alt={mainStore.name}
