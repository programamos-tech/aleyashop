  ...
  return (
    <div className="fixed top-0 right-0 bottom-0 left-64 bg-black/20 backdrop-blur-sm z-50 flex items-center justify-center pl-6 pr-4">
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-4xl max-h-[95vh] overflow-hidden flex flex-col border border-gray-200 dark:border-gray-700">
        {/* Header */}
        <div className="flex items-center justify-between p-6 bg-[#fce4f0] dark:bg-[#f29fc8]/20 border-b border-[#f29fc8]/50 dark:border-[#d06a98]">
          <div className="flex items-center space-x-3">
            <Upload className="h-6 w-6 text-[#f29fc8] dark:text-[#f29fc8]" />
            <div>
              <h2 className="text-xl font-semibold text-[#d06a98] dark:text-[#f29fc8]/50">
                Importar Productos desde CSV
              </h2>
              <p className="text-sm text-[#d06a98] dark:text-[#f29fc8]">
        ...
        <div className="p-6 flex-1 bg-white dark:bg-gray-900 overflow-y-auto">
          <div className="space-y-6">
            {/* Instrucciones */}
            <Card className="bg-[#fce4f0] dark:bg-[#f29fc8]/20 border-[#f29fc8]/50 dark:border-[#d06a98]">
              <CardHeader>
                <CardTitle className="text-lg text-[#d06a98] dark:text-[#f29fc8]/50 flex items-center">
                  <FileText className="h-5 w-5 mr-2" />
                  Formato del Archivo CSV
                </CardTitle>
              </CardHeader>
              <CardContent className="text-[#d06a98] dark:text-[#f29fc8]">
              ...
              <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                <CardHeader>
                  <CardTitle className="text-lg text-gray-900 dark:text-white flex items-center">
                    <CheckCircle className="h-5 w-5 mr-2 text-[#fce4f0]0" />
                      ...
                      {parsedProducts.map((product, index) => (
                        <div key={index} className="flex items-center justify-between p-2 bg-white dark:bg-gray-700 rounded border border-gray-200 dark:border-gray-600">
                          <div className="flex items-center space-x-2">
                            <Package className="h-3 w-3 text-[#fce4f0]0" />
                            <div>
