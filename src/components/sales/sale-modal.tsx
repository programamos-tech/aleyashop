            ...
            <div className={`xl:col-span-3 space-y-4 relative`}>
              ...
              <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow">
                ...
                <CardContent className="p-4 pt-0">
                    ...
                    <div className="relative">
                      <div className="relative">
                        ...
                        onChange={(e) => {
                          ...
                          className="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#fce4f0]0 focus:border-[#fce4f0]0 placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-white bg-white dark:bg-gray-700"
                        />
                      </div>
                    </div>
                  ...
                  {selectedClient && (
                    <div className="mt-3 p-3 bg-[#fce4f0] dark:bg-[#f29fc8]/20 rounded-lg border border-[#f29fc8]/50 dark:border-[#fce4f0]0/30">
                                ...
                                <button
                                  ...
                                  className={`w-full px-3 py-3 text-left rounded-lg transition-all group ${
                                    selectedProductIndex === index
                                      ? 'bg-[#fce4f0] dark:bg-[#f29fc8]/20 border border-[#f29fc8] dark:border-[#f29fc8] shadow-sm'
                                      : 'hover:bg-gray-50 dark:hover:bg-gray-600/50 border border-transparent'
                                  }`}
                                >
                                  <div className="flex items-start justify-between gap-3">
                                    <div className="flex-1 min-w-0">
                                      <div className="font-semibold text-gray-900 dark:text-white text-sm mb-1.5 group-hover:text-[#e07ab0] dark:group-hover:text-[#f29fc8] transition-colors">
                                        {product.name}
                                      </div>
                                      ...
                                      <div className="flex items-center justify-between gap-2 flex-wrap">
                                        ...
                                        <Badge className={`text-xs whitespace-nowrap ${
                                          getStockStatus(product.id) === 'Disponible Local' 
                                            ? 'bg-[#fce4f0] text-[#d06a98] border border-[#f29fc8] dark:bg-[#f29fc8]/30 dark:text-[#f29fc8] dark:border-[#f29fc8]' 
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full px-3 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#fce4f0]0 focus:border-[#fce4f0]0 bg-white dark:bg-gray-700 appearance-none cursor-pointer text-gray-900 dark:text-white"
                      >
                        ...
                        <div className="space-y-2">
                            ...
                            <div key={index} className="space-y-2">
                              <div>
                                ...
                                <input
                                  ...
                                  placeholder="0"
                                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-[#fce4f0]0 focus:border-transparent bg-white dark:bg-gray-600 text-gray-900 dark:text-white text-sm"
                                />
                              </div>
                            </div>
                          ))}
                          ...
                          <div className="pt-3 border-t border-gray-200 dark:border-gray-600 space-y-2">
                            ...
                            <div className="flex justify-between items-center text-sm">
                              ...
                              <span className={`font-medium ${Math.round(getTotalMixedPayments()) === Math.round(total) && validProducts.length > 0 ? 'text-[#f29fc8] dark:text-[#f29fc8]' : 'text-gray-900 dark:text-white'}`}>
                            ...
                            {Math.round(getTotalMixedPayments()) === Math.round(total) && validProducts.length > 0 && (
                              <div className="flex justify-between items-center text-sm font-medium pt-1 border-t border-gray-200 dark:border-gray-700">
                                <div className="flex items-center gap-2 text-[#f29fc8] dark:text-[#f29fc8]">
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <div className="flex items-center space-x-2">
                                <input
                                  ...
                                  className="h-4 w-4 text-[#f29fc8] focus:ring-[#fce4f0]0 border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-600"
                                />
                            ...
                            <div className="border-t border-gray-200 dark:border-gray-600 pt-3 mt-3 space-y-3">
                              <div className="space-y-2">
                                ...
                                <div className="relative">
                                  ...
                                  <input
                                    ...
                                    className="w-full pl-8 pr-3 py-2.5 text-lg font-semibold border-2 border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#fce4f0]0 focus:border-[#fce4f0]0 bg-white dark:bg-gray-600 text-gray-900 dark:text-white"
                                  />
                                </div>
                              </div>
                              ...
                              {receivedAmount && parseFloat(receivedAmount.replace(/[^\d]/g, '')) > 0 && (
                                <div className={`rounded-lg p-4 border-2 ${
                                  ...
                                  {parseFloat(receivedAmount.replace(/[^\d]/g, '')) >= total && (
                                    <div className="flex items-center gap-2 text-sm text-[#f29fc8] dark:text-[#f29fc8] mt-2 font-medium">
                                      <CheckCircle className="h-4 w-4" />
                                      <span>Pago completo</span>
                                    </div>
                                  )}
          ...
          <div className="flex items-center justify-end gap-3">
            ...
            {!sale && (
              <Button
                ...
                className="font-medium px-6 py-2.5 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed bg-[#f29fc8] hover:bg-[#e07ab0] text-white"
              >
                Crear Venta
              </Button>
            )}
